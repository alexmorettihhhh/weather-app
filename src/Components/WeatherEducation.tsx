        ...
        questions: [
            {
                ...
                options: [
                    'Вес воздушного столба над поверхностью',
                    'Температура воздуха',
                    'Скорость ветра',
                    'Влажность воздуха'
                ],
                correctAnswer: 0,
                explanation: 'Атмосферное давление - это вес столба воздуха над единицей площади поверхности.'
            },
            {
                id: 'q2',
                ...
                correctAnswer: 2,
                explanation: 'Гигрометр - прибор для измерения относительной влажности воздуха.'
            },
            {
                id: 'q3',
...
const mockInteractiveMaterials: InteractiveMaterial[] = [
    {
        ...
        type: 'simulation',
        content: 'Интерактивная модель процесса образования различных типов облаков',
        instructions: [
            'Установите температуру воздуха',
            'Отрегулируйте влажность',
            'Наблюдайте за процессом конденсации'
        ],
        ageGroup: 'teenager',
        requirements: ['Современный браузер', 'WebGL']
    },
    {
        id: '2',
        title: 'Эксперимент: Создание торнадо в бутылке',
        type: 'experiment',
        content: 'Простой эксперимент для демонстрации вихревого движения',
        instructions: [
            'Наполните бутылку водой',
            'Добавьте блестки или пищевой краситель',
            'Создайте вихрь вращательным движением'
        ],
        ageGroup: 'children',
        requirements: ['Пластиковая бутылка', 'Вода', 'Блестки']
    }
];
